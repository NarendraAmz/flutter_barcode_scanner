 ...
 */
public class FlutterBarcodeScannerPlugin implements MethodCallHandler, FlutterPlugin {
    ...
    // FlutterBarcodeScannerPlugin.class.getSimpleName();
    ...
    // private FlutterBarcodeScannerPlugin(FlutterActivity activity, final
    // PluginRegistry.Registrar registrar) {
    // FlutterBarcodeScannerPlugin.activity = activity;
    // }

    public static void registerWith(Registrar registrar) {
        final MethodChannel channel = new MethodChannel(registrar.messenger(), "flutterbarcodescanner");
    ...
    // // }
    // // FlutterBarcodeScannerPlugin instance = new
    // // FlutterBarcodeScannerPlugin((FlutterActivity) registrar.activity(),
    // // registrar);
    // // instance.createPluginSetup(registrar.messenger(), applicationContext,
    // // activity, registrar, null);
    ...
    public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
        ...
        // if ((int) arguments.get("scanMode") ==
        // BarcodeCaptureActivity.SCAN_MODE_ENUM.DEFAULT.ordinal()) {
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        channel = new MethodChannel(flutterPluginBinding.getFlutterEngine().getDartExecutor(), "flutterbarcodescanner");
    ...
    // private void startBarcodeScannerActivityView(String buttonText, boolean
    // isContinuousScan) {
    // try {
    // Intent intent = new Intent(activity,
    // BarcodeCaptureActivity.class).putExtra("cancelButtonText", buttonText);
    // if (isContinuousScan) {
